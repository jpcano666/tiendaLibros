...
public class TransaccionTest
{
    ...
    {
        libro = new Libro( "Las mil y una noches", "HAGFSD123", 34000, 50000, "Cuento Infantil", "" );
        fecha = new Date( );
    }
    ...
    private void setupEscenario2( )
    {
        ...
        libro.vender( 20, fecha );
        libro.vender( 10, fecha );
        libro.abastecer( 5, fecha );
    }
    ...
    public void testTDarPrecio( )
    {
        ...
        libro.abastecer( 50, fechaTransaccion );
        ArrayList<Transaccion> transacciones = libro.darTransacciones( );
        assertTrue( "La fecha es incorrecta", transacciones.get( 0 ).darFecha( ).equals( fechaTransaccion ) );
    }
    
    /**
     * Prueba 11 - Cambiar siguiente
     */
    @Test
    public void testCambiarSiguiente( )
    {
        Transaccion transaccion = new Transaccion( Tipo.VENTA, 50, new Date() );
        assertTrue( "No debería haber una siguiente", transaccion.darSiguiente( ) == null );
        transaccion.cambiarSiguiente( new Transaccion( Tipo.VENTA, 100, new Date()) );
        assertTrue( "No se está cambiando ña siguiente transacción..", transaccion.darSiguiente( ) != null );
        assertTrue( "La transacción siguiente no es correcta.", transaccion.darSiguiente( ).darCantidad( ) == 100);
    }
}
